...
# Forward reference for typing
DOMElementNodeType = 'DOMElementNode'

@dataclass
class DOMTextNode:
    text: str
    is_visible: bool
    parent: Optional[DOMElementNodeType] = None
    node_type: str = 'TEXT_NODE'
...
class DOMElementNode:
    ...
    is_visible: bool
    children: List[Union[DOMTextNode, DOMElementNodeType]] = field(default_factory=list)
    parent: Optional[DOMElementNodeType] = None
...
# Type for mapping highlight indices to DOM elements
